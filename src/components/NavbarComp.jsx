    ...
    return (
        <Router>
          <div classsName="navbar">
            ...
            <Container>
              <Navbar.Brand as={Link} to={"/Home"}>Learners <span>Space</span></Navbar.Brand>
              <Navbar.Toggle aria-controls="basic-navbar-nav" />
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link as={Link} to={"/"}>Home</Nav.Link>
                  <Nav.Link as={Link} to={"/inventories/Music"}>Music</Nav.Link>
                  <Nav.Link as={Link} to={"/inventories/Sports"}>Sports</Nav.Link>
