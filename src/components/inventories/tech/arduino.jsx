        ...
        <div>
            <h1>Arduino Board</h1>
                ...
                <Card.Body className="bg-dark" style = {{'justify':'center'}}>
                    ...
                    <Button onClick={()=>{const x = <div className="cart-item">UNO R3 SMD <span>485</span>Rs</div>; updateCart(x);}} variant="primary" style={{'font-weight':'bold', 'margin':'0.3em auto'}}>Add To Cart</Button>
                </Card.Body>
                </Card>
                </Col>
                <Col>
                ...
                <Card.Body className="bg-dark" style = {{'justify':'center'}}>
                    ...
                    <Button onClick={()=>{const x = <div className="cart-item">MEGA 2560 R3 <span>500</span>Rs</div>; updateCart(x);}}  variant="primary" style={{'font-weight':'bold', 'margin':'0.3em auto'}} >Add To Cart</Button>
                </Card.Body>
                </Card>
                </Col>
                </Row>
